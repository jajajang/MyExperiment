...
outf_center=open('180826_centy_soft_sub.txt','w')
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train(train_loader, model, criterion_, criterionC_, optimizer, epoch, level)
    torch.save(model.module.state_dict(),'mytraining.pt')

def train(train_loader, model, criterion, criterionC, optimizer, epoch, level):
